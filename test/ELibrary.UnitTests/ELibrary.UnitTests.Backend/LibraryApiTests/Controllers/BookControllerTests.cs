...
namespace LibraryApi.Controllers.Tests
{
    ...
    internal class BookControllerTests
    {
        ...
        public async Task GetByIds_ValidRequest_ReturnsOkWithItems()
        {
            ...
            Assert.That(((IEnumerable<BookResponse>)okResult.Value).Count(), Is.EqualTo(2));
        }
        ...
        public async Task GetPaginated_ValidRequest_ReturnsOkWithPaginatedResults()
        {
            ...
            Assert.That(((IEnumerable<BookResponse>)okResult.Value).Count(), Is.GreaterThan(1));
        }
        ...
        {
            // Arrange
            var book = new Book { Id = 1, Name = "Dune", PublicationDate = new DateTime(1965, 8, 1, 0, 0, 0, DateTimeKind.Utc), AuthorId = 1, GenreId = 1 };

            var createRequest = new CreateBookRequest { Name = "Dune", PublicationDate = new DateTime(1965, 8, 1, 0, 0, 0, DateTimeKind.Utc), AuthorId = 1, GenreId = 1 };
            var createResponse = new BookResponse { Id = 1, Name = "Dune", PublicationDate = new DateTime(1965, 8, 1, 0, 0, 0, DateTimeKind.Utc) };
        ...
        public async Task Update_ValidRequest_ReturnsOk()
        {
            ...
            var updateRequest = new UpdateBookRequest { Id = 1, Name = "Dune", PublicationDate = new DateTime(1965, 8, 1, 0, 0, 0, DateTimeKind.Utc), AuthorId = 1, GenreId = 1 };
            var updatedResponse = new BookResponse { Id = 1, Name = "Dune", PublicationDate = new DateTime(1965, 8, 1, 0, 0, 0, DateTimeKind.Utc) };
