    ...
    internal class BaseOrderControllerTest : BaseControllerTest
    {
        ...
        protected async Task AddOrdersToClientAsync(string accessToken)
        {
            ...
            await GetPostgreSqlContainer().ExecScriptAsync(
                $"INSERT INTO public.orders (id, created_at, updated_at, order_amount, total_price, delivery_address, delivery_time, order_status, payment_method, delivery_method, client_id) VALUES(1, '2024-11-02 14:20:58.870', '2024-11-02 14:20:58.871', 1, 500.00, '2', '2024-11-03 06:30:00.000', 0, 0, 0, '{client.Id}');" +
