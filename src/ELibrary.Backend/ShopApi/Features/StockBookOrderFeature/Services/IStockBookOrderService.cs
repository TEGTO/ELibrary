...
namespace ShopApi.Features.StockBookOrderFeature.Services
{
    public interface IStockBookOrderService
    {
        ...
        public Task<StockBookOrder> AddStockBookOrderAsyncFromCanceledOrderAsync(Order order, CancellationToken cancellationToken);
        public Task<StockBookOrder> AddStockBookOrderAsyncFromOrderAsync(Order order, CancellationToken cancellationToken);
