...
namespace ShopApi.Migrations
{
    ...
    [Migration("20241115132745_AddedContactClientInfoToOrder")]
    partial class AddedContactClientInfoToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryShopEntities.Domain.Entities.Shop.Order", b =>
                {
                    ...
                    b.Property<string>("ContactClientName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("contact_client_name");
