...
@NgModule({
  ...
  providers: [
    ...
    { provide: START_ADDING_CLIENT_COMMAND_HANDLER, useClass: StartAddingClientCommandHandlerService },
    ...
    { provide: CLIENT_START_ADDING_ORDER_COMMAND_HANDLER, useClass: ClientStartAddingOrderCommandHandlerService },
